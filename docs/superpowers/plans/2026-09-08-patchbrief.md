...
- [ ] Add `src/bookmarklet/types.ts` with `VERSION`, `RectSnapshot`, `SelectionRecord`, `BriefDraft`, `Preferences`, and `SpotBriefController` definitions.
