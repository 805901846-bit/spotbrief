...
**Goal:** Add a screenshot-specific instruction field, default-collapsed code and constraint sections, five preselected safe constraints, and remove the expected-result field from the current PatchBrief workflow.
...
Test these visible behaviors after launching PatchBrief:
...
- Modify: `README.md`
- Modify: `docs/guides/PatchBrief-零基础使用说明书.md`
...
```bash
git add README.md docs/guides/PatchBrief-零基础使用说明书.md tests/e2e/screenshot.spec.ts src/bookmarklet/index.ts
