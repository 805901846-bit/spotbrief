...
**Goal:** Add user-authorized rectangular viewport screenshots and a draggable, remembered desktop panel to PatchBrief.
...
- [ ] Write a failing Playwright test that drags the top bar, verifies position changes, recreates PatchBrief to verify persistence, and resets the default position.
